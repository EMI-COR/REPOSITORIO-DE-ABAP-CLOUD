CLASS zcl_jugador_base_05 DEFINITION
   PUBLIC
  ABSTRACT
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES zif_puntuable_05.
    INTERFACES zif_clasificable_05.
...
CLASS zcl_jugador_base_05 IMPLEMENTATION.
METHOD constructor.
    mv_nombre    = iv_nombre.
    mv_pais      = iv_pais.
    mv_victorias = 0.
  ...
  METHOD zif_clasificable_05~esta_clasificado.
    IF mv_victorias > 5.
      rv_result = abap_true.
    ELSE.
  ...
  METHOD zif_clasificable_05~get_posicion_ranking.
